...
interface D7ServiceCardProps { icon: string; title: string; desc: string; noHover?: boolean; }
...
export default function D7ServiceCard({ icon, title, desc, noHover }: D7ServiceCardProps) {
