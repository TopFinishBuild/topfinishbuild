...
interface D7AboutPageProps {
  onNavigate: (href: string) => void;
}

export default function D7AboutPage({ onNavigate }: D7AboutPageProps) {
  ...
  return (
    <div style={{ background: '#fff' }}>
      ...
      <div style={{ background: NAVY, padding: isMobile ? '60px 24px 50px' : '100px 48px 80px', textAlign: 'center' }}>
        <span className="d7-label" style={{ marginBottom: 12, display: 'inline-block' }}>За нас</span>
        <h1 className="d7-section-title" style={{ color: '#fff', marginTop: 10, fontSize: isMobile ? 36 : 54 }}>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: isMobile ? '60px 24px' : '100px 48px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? 48 : 80, alignItems: 'center', marginBottom: isMobile ? 60 : 100 }}>
          <div>
            <span className="d7-label">Нашата история</span>
            <h2 className="d7-section-title" style={{ marginTop: 10 }}>
              ПОВЕЧЕ ОТ <em>12 ГОДИНИ</em><br/>В БРАНША
            </h2>
            <div className="d7-divider" style={{ margin: '16px 0' }} />
        ...
        <div style={{ marginBottom: isMobile ? 60 : 100 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <span className="d7-label">Какво правим</span>
            <h2 className="d7-section-title" style={{ marginTop: 10 }}>
        ...
        <div style={{ marginBottom: isMobile ? 60 : 100 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <span className="d7-label">Екипът</span>
            <h2 className="d7-section-title" style={{ marginTop: 10 }}>
        ...
        <div style={{ marginBottom: isMobile ? 60 : 100 }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <span className="d7-label">Нашите ценности</span>
            <h2 className="d7-section-title" style={{ marginTop: 10 }}>
