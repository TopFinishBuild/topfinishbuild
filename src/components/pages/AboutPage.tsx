...
const VALUES = [
  ...
  },
  {
    ...
    desc: 'Работим в партньорство с професионален интериорен дизайнер, както и по изцяло ваши проекти.',
  },
];
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? 48 : 80, alignItems: 'center', marginBottom: isMobile ? 60 : 100 }}>
          <div>
            ...
            <p style={{ fontFamily: FH, fontSize: 16, color: GRAY, lineHeight: 1.9 }}>
              Нашият екип включва сертифицирани майстори по: полагане на всякакъв вид плочки, шпакловчици, бояджии, всички видове мазилки, гипсокартон, ВиК и електро инсталации, изолация и др. При необходимост работим и с партньорски интериорен дизайнер, за да осигурим пълноценно решение от идеята до завършения обект.
            </p>
          </div>
